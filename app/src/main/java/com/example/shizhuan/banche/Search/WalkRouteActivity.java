...
public class WalkRouteActivity extends Activity implements OnMapClickListener,
	...
	private LatLonPoint mStartPoint = new LatLonPoint(22.566324,113.882805);//起点，116.335891,39.942295
			...
			public void onLocationChanged(AMapLocation amapLocation) {
				if (amapLocation != null) {
					if (amapLocation.getErrorCode() == 0) {
						...
						Toast.makeText(WalkRouteActivity.this,"AmapError"+amapLocation.getErrorCode()+amapLocation.getErrorInfo(),Toast.LENGTH_LONG).show();
